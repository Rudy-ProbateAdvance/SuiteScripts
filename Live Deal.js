function Live_Deal(request,response)
{
	var form = nlapiCreateForm("LIVE DEAL");
	...
	var search = nlapiLoadSearch("customrecord_case_status","customsearch_live_deal_customers");
	...
	do{
		var results = resultSet.getResults(searchId,searchId+1000);
           nlapiLogExecution("debug",'result',results.length);
