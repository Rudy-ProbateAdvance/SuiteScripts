...
//                form.addSubTab("phonecalls", "Phone Calls", "communication");
        ...
        fld = form.addField("custpage_tech_notes", "textarea", "Tech Notes", null, "custom_tab");
...
//  var eid=nlapiGetFieldValue("custpage_estate");
          ...
          if (uu=='2299863' || uu=='2698763' || uu=='848463') {
            if (cid)
              form.addButton('custpage_nativeform', 'Customer Native Form', "window.location.href='/app/common/entity/custjob.nl?id=" + cid + "&native=T'");
            if (eid)
              form.addButton('custpage_nativeform', 'Estate Native Form', "window.location.href='/app/common/entity/custjob.nl?id=" + eid + "&native=T'");
            if (!cid && !eid)
...
//                    filters.push(new nlobjSearchFilter("company", null, "is", estateId));
          ...
          cols.push(new nlobjSearchColumn("custentity_attorney_notes"));
...
//              fld.setDisplayType('disabled');
        if (attorneyFlds != null)
          var attynotes = attorneyFlds.getValue("custentity_attorney_notes");
        if (attynotes) {
