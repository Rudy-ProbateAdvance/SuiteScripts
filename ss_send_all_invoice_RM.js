...
//        ["type", "anyof", "CustInvc"], "AND", ["mainline", "is", "T"], "AND", ["status", "anyof", "CustInvc:A"], 'AND', ["trandate", "within", lastweek, todatDate]
        ["type", "anyof", "CustInvc"], "AND", ["mainline", "is", "T"], 'AND', ["trandate", "within", lastweek, todatDate]
      ];
        ...
        for (var y = 0; y < columns.length; y++) {
          ...
          if (columns[y].label != 'Internal ID') {
            ...
            if (columns[y].label == 'ESTATE' || columns[y].label == 'Estate') {
              ...
              searchValue = searchValue.toString().replace(/\r/g, "");
      ...
      if(rc) {
          ...
          do {
              ...
              page.data.forEach(function(result){
                ...
                var estate={};
                estate.estate=(result.getValue({name:"entityid"})+' '+result.getValue({name:"altname"})).replace(/,/g, ' ');
